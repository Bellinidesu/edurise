...
public class FillOutFormPanel extends JPanel {
    ...
    private void setupLayout() {
        ...
        // Create a horizontal panel for the form sections
        JPanel formPanel = new JPanel();
        formPanel.setLayout(new GridLayout(1, 3, 10, 0)); // 1 row, 3 columns, horizontal gap
        formPanel.setBackground(UIUtils.BACKGROUND_COLOR);
        formPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));

        // Personal & Student Information Section
